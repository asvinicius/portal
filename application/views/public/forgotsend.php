            	...
            	<div class="container">
                	<div class="row">
                    	<div class="col-md-8 col-md-offset-2">
							...
							<h6>Um e-mail foi enviado para prosseguir a recuperação de senha. Verifique sua caixa de entrada e spam.</h6>
                        	<div class="text-center">
								<a type="button" href="<?= base_url('login'); ?>" class="btn btn-fill btn-primary btn-wd">Ir para login</a>
							</div>
                    	</div>	
                	</div>
            	</div>
